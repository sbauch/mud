...
contract QueryTest is Test, GasReporter {
  ...
  function _installKeysInTableModule() internal {
    ...
    table1 = world.registerTable(namespace, name1, tableKeySchema, tableValueSchema, new string[](1), new string[](1));
    table2 = world.registerTable(namespace, name2, tableKeySchema, tableValueSchema, new string[](1), new string[](1));
    table3 = world.registerTable(namespace, name3, tableKeySchema, tableValueSchema, new string[](1), new string[](1));
  ...
  function testHasQuery() public {
    ...
    world.setRecord(namespace, name1, key1, abi.encode(1), tableValueSchema);
    world.setRecord(namespace, name1, key2, abi.encode(1), tableValueSchema);
    world.setRecord(namespace, name2, key1, abi.encode(0), tableValueSchema);
  ...
  function testHasValueQuery() public {
    ...
    world.setRecord(namespace, name1, key1, abi.encode(2), tableValueSchema);
    world.setRecord(namespace, name1, key2, abi.encode(1), tableValueSchema);
    world.setRecord(namespace, name1, key3, abi.encode(1), tableValueSchema);
  ...
  function testCombinedHasQuery() public {
    ...
    world.setRecord(namespace, name1, key2, abi.encode(1), tableValueSchema);
    world.setRecord(namespace, name1, key3, abi.encode(1), tableValueSchema);
    world.setRecord(namespace, name2, key2, abi.encode(1), tableValueSchema);
    world.setRecord(namespace, name2, key3, abi.encode(1), tableValueSchema);
    world.setRecord(namespace, name3, key1, abi.encode(1), tableValueSchema);
  ...
  function testCombinedHasValueQuery() public {
    ...
    world.setRecord(namespace, name1, key1, abi.encode(2), tableValueSchema);
    world.setRecord(namespace, name1, key2, abi.encode(2), tableValueSchema);
    world.setRecord(namespace, name1, key3, abi.encode(1), tableValueSchema);
    world.setRecord(namespace, name2, key2, abi.encode(1), tableValueSchema);
    world.setRecord(namespace, name2, key3, abi.encode(1), tableValueSchema);
    world.setRecord(namespace, name3, key1, abi.encode(1), tableValueSchema);
  ...
  function testCombinedHasHasValueQuery() public {
    ...
    world.setRecord(namespace, name1, key2, abi.encode(1), tableValueSchema);
    world.setRecord(namespace, name1, key3, abi.encode(1), tableValueSchema);
    world.setRecord(namespace, name2, key1, abi.encode(1), tableValueSchema);
    world.setRecord(namespace, name2, key2, abi.encode(2), tableValueSchema);
    world.setRecord(namespace, name2, key3, abi.encode(2), tableValueSchema);
    world.setRecord(namespace, name2, key4, abi.encode(2), tableValueSchema);
  ...
  function testCombinedHasValueNotQuery() public {
    ...
    world.setRecord(namespace, name2, key2, abi.encode(2), tableValueSchema);
    world.setRecord(namespace, name2, key3, abi.encode(1), tableValueSchema);
    world.setRecord(namespace, name2, key4, abi.encode(1), tableValueSchema);
  ...
  function testCombinedHasHasValueNotQuery() public {
    ...
    world.setRecord(namespace, name2, key3, abi.encode(1), tableValueSchema);
    world.setRecord(namespace, name2, key4, abi.encode(1), tableValueSchema);
    world.setRecord(namespace, name3, key2, abi.encode(1), tableValueSchema);
    world.setRecord(namespace, name3, key3, abi.encode(1), tableValueSchema);
    world.setRecord(namespace, name3, key4, abi.encode(1), tableValueSchema);
  ...
  function testNotValueQuery() public {
    ...
    world.setRecord(namespace, name1, key1, abi.encode(4), tableValueSchema);
    world.setRecord(namespace, name1, key2, abi.encode(5), tableValueSchema);
    world.setRecord(namespace, name1, key3, abi.encode(6), tableValueSchema);
  ...
  function testHasQuery100Keys() public {
    ...
    for (uint256 i; i < 100; i++) {
      ...
      key[0] = bytes32(i);
      world.setRecord(namespace, name1, key, abi.encode(1), tableValueSchema);
    }
    world.setRecord(namespace, name2, key1, abi.encode(0), tableValueSchema);
