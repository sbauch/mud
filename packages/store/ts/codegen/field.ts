  ...
  for (const [schemaIndex, field] of options.fields.entries()) {
    ...
    result += renderWithStore(
      ...
      function get${field.methodNameSuffix}(${renderArguments([
        ...
        ${_keyTupleDefinition}
        bytes memory _blob = ${_store}.getField(_tableId, _keyTuple, ${schemaIndex}, getValueSchema());
    ...
    result += renderWithStore(
      ...
      function set${field.methodNameSuffix}(${renderArguments([
        ...
        ${_keyTupleDefinition}
        ${_store}.setField(_tableId, _keyTuple, ${schemaIndex}, ${renderEncodeField(field)}, getValueSchema());
      }
    `
    );
    ...
    if (field.isDynamic) {
      ...
      result += renderWithStore(
        ...
        function length${field.methodNameSuffix}(${renderArguments([
          ...
          ${_keyTupleDefinition}
          uint256 _byteLength = ${_store}.getFieldLength(_tableId, _keyTuple, ${schemaIndex}, getValueSchema());
      ...
      result += renderWithStore(
        ...
        function push${field.methodNameSuffix}(${renderArguments([
          ...
          ${_keyTupleDefinition}
          ${_store}.pushToField(_tableId, _keyTuple, ${schemaIndex}, ${portionData.encoded}, getValueSchema());
        }
      `
      );
      ...
      result += renderWithStore(
        ...
        function pop${field.methodNameSuffix}(${renderArguments([
          ...
          ${_keyTupleDefinition}
          ${_store}.popFromField(_tableId, _keyTuple, ${schemaIndex}, ${portionData.elementLength}, getValueSchema());
        }
      `
      );
