...
import { StoreMetadataData, StoreMetadata, TableData, TableDataTableId } from "../src/codegen/Tables.sol";
...
contract StoreCoreTest is Test, StoreMock {
  ...
  function testRegisterAndGetSchema() public {
    ...
    Schema valueSchema = SchemaLib.encode(SchemaType.UINT8, SchemaType.UINT16, SchemaType.UINT8, SchemaType.UINT16);
    ...
    emit StoreSetRecord(
      TableDataTableId,
      key,
      TableData.encode(keySchema.unwrap(), valueSchema.unwrap(), abi.encode(keyNames), abi.encode(valueNames))
    );
    IStore(this).registerTable(table, keySchema, valueSchema, keyNames, valueNames);
    ...
    bytes memory loadedKeyNames = TableData.getAbiEncodedKeyNames(IStore(this), table);
    assertEq(loadedKeyNames, abi.encode(keyNames));

    bytes memory loadedValueNames = TableData.getAbiEncodedValueNames(IStore(this), table);
    assertEq(loadedValueNames, abi.encode(valueNames));
  }
  ...
  function testHasSchema() public {
    ...
    IStore(this).registerTable(table, defaultKeySchema, valueSchema, keyNames, valueNames);
  ...
  function testRegisterTableRevertNames() public {
    ...
    Schema valueSchema = SchemaLib.encode(SchemaType.UINT8);
  ...
  function testSetAndGetDynamicDataLength() public {
    ...
    Schema valueSchema = SchemaLib.encode(
      SchemaType.UINT8,
      SchemaType.UINT16,
      SchemaType.UINT32,
  ...
  function testSetAndGetStaticDataSpanningWords() public {
    // Register table's schema
    Schema valueSchema = SchemaLib.encode(SchemaType.UINT128, SchemaType.UINT256);
    bytes32 table = keccak256("some.table");
  ...
  function testSetAndGetDynamicData() public {
    ...
    // Register table's schema
    Schema valueSchema = SchemaLib.encode(SchemaType.UINT128, SchemaType.UINT32_ARRAY, SchemaType.UINT32_ARRAY);
  ...
  function testUpdateInField() public {
    ...
    // Register table's schema
    Schema valueSchema = SchemaLib.encode(SchemaType.UINT256, SchemaType.UINT32_ARRAY, SchemaType.UINT64_ARRAY);
    IStore(this).registerTable(data.table, defaultKeySchema, valueSchema, new string[](1), new string[](3));
  ...
  function testAccessEmptyData() public {
    bytes32 table = keccak256("some.table");
    Schema valueSchema = SchemaLib.encode(SchemaType.UINT32, SchemaType.UINT32_ARRAY);
  ...
  function testHooks() public {
    ...
    // Register table's schema
    Schema valueSchema = SchemaLib.encode(SchemaType.UINT128);
  ...
  function testHooksDynamicData() public {
    ...
    // Register table's schema
    Schema valueSchema = SchemaLib.encode(SchemaType.UINT128, SchemaType.UINT32_ARRAY);
    IStore(this).registerTable(table, defaultKeySchema, valueSchema, new string[](1), new string[](2));
