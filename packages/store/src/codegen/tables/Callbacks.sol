...
library Callbacks {
  ...
  function getItem(IStore _store, bytes32 key, uint256 _index) internal view returns (bytes24) {
    ...
    bytes memory _blob = _store.getFieldSlice(_tableId, _keyTuple, 0, getValueSchema(), _index * 24, (_index + 1) * 24);
    return (Bytes.slice24(_blob, 0));
  }
  ...
  function pop(bytes32 key) internal {
    ...
    StoreSwitch.popFromField(_tableId, _keyTuple, 0, 24, getValueSchema());
  }
  ...
  function pop(IStore _store, bytes32 key) internal {
    ...
    _store.popFromField(_tableId, _keyTuple, 0, 24, getValueSchema());
  }
  ...
  function update(bytes32 key, uint256 _index, bytes24 _element) internal {
    ...
    StoreSwitch.updateInField(_tableId, _keyTuple, 0, _index * 24, abi.encodePacked((_element)), getValueSchema());
  }
  ...
  function update(IStore _store, bytes32 key, uint256 _index, bytes24 _element) internal {
    ...
    _store.updateInField(_tableId, _keyTuple, 0, _index * 24, abi.encodePacked((_element)), getValueSchema());
  }
