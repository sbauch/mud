...
library TableData {
  ...
  /** Get an item of abiEncodedKeyNames (unchecked, returns invalid data if index overflows) */
  ...
  /** Get an item of abiEncodedKeyNames (using the specified store) (unchecked, returns invalid data if index overflows) */
  ...
  /** Get an item of abiEncodedValueNames (unchecked, returns invalid data if index overflows) */
  ...
  /** Get an item of abiEncodedValueNames (using the specified store) (unchecked, returns invalid data if index overflows) */
